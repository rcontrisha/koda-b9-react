          ...
          <div className="flex px-8 py-4 gap-4">
            <div className="border rounded-lg">
              ...
              <div className="flex border-t">
                ...
                <img
                  ...
                  className="border-r"
                ></img>
                <img src={detail.sprites["back_shiny"]}></img>
              </div>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-2 items-center">
                {detail.types.map((type, idx) => {
                  return (
                    <div
                      key={idx}
                      className="px-2 py-1 border-2 border-gray-600 w-fit rounded-full"
                    >
                      {type.type.name}
                    </div>
                  );
              ...
              <div>
                ...
                <div className="flex gap-2 items-center">
                  {detail.abilities.map((ability, idx) => {
                    return (
                      <div
                        key={idx}
